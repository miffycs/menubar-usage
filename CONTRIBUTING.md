...
Releases are cut by the maintainer (bump version in `pyproject.toml`, commit `Release vX.Y.Z`, push tag). `CHANGELOG.md` is optional; if you keep one, add an entry there.
